...
\begin{frame}
  \frametitle{Faîtes des titres qui informent. Utilisez des lettres capitales (en Anglais).}
  \framesubtitle{Les sous-titres sont facultatifs.}
...
\begin{frame}
  \frametitle{Faîtes des titres qui informent}
...
\begin{frame}
  \frametitle<presentation>{Résumé}
