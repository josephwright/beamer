...
% Obiges ist nur für die Artikelversion von Bedeutung. Falls eine
% solche nicht erstellt wird, kann dies gelöscht werden. Es schadet
% sonst aber auch nicht.

\mode<presentation>
{
  % Falls ein Hintergrundsbild/-farbe eingestellt werden soll, dann
  % sollte dies geschehen *bevor* das Thema geladen wird.
  % Z.B.: \beamertemplateshadingbackground{beamerstructure!10}{white}
...
\title[Kurzversion des Titels] % (optional, nur bei langen Titel nötig)
{Title wie im Tagunsband angegeben\\ (u.U.\ also englisch)}
...
{Konferenz über Präsentationstechniken, 2003}
% - Vollen oder abgekürzter Name sind möglich.
...
% Dies sollte gelöscht werden, wenn man nicht am Anfang jedes
...
\subsection{Das behandlete Problem}

\begin{frame}
  \frametitle{Überschriften sollten informativ sein.\\
