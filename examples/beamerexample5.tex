...
\subsection[Weak Cardinality Theorem in Recursion \ldots]{Weak Cardinality Theorems in Recursion and Automata Theory}
...
\frame
{
  ...
  \begin{block}{Weak Cardinality Theorems (\alert<2>{1987}, \alert<3>{1989}, \alert<4>{1992})}<2->
    \begin{itemize}
    \item<2->
      \alert<2>{If $\chi_A^n$ is $n$-enumerable by a Turing machine, then $A$ is
        recursive.}
    \item<3->
