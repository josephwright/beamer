...
It is a \LaTeX\ class that allows you to create a presentation to be
held using a projector. It can also be used to create transparency
slides. It behaves similarly to other packages like \textsc{prosper},
...
no means well-structured or well-written. Hopefully
...
If you have not yet installed the package, please read
Section~\ref{section-installation} first. If you do not have much
experience with preparing presentations, the subsections named
``Guidelines'' at the beginning of certain sections may be especially
helpful. They contain 
advice on how to create good presentations and do not refer
specifically to the \beamer\ class. When you create your first
presentation using \beamer, you might wish to read 
Section~\ref{section-workflow} first, which outlines how you should
proceed. The later sections explain the basic usage of the |beamer|
class as well as advanced features. You can easily change the way your
presentation looks by using an appropriate theme. The themes are
documented in the third part of this user's guide.
...
Whenever a \beamer\ solution template exists for a specific problem,
this will be pointed out in the (sub-)section that treats the topic of
this problem. 
