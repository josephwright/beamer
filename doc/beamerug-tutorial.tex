...
\end{verbatim}
might be appropriate. He creates a subdirectory |presentation| in
...
subsection in the navigation bar at the top hyperjumps there. Also,
...
not to write an email to \beamer's author since he also thinks that
...
to different heights of the text on the first three slides and on the
...
On another frame, Euclid would like to show a listing of an
algorithm his friend Eratosthenes has sent him (saying he came up with
