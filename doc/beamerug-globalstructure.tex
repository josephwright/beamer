...
|\part|. These commands are used to create a \emph{static} structure,
...
\begin{command}{\title\oarg{short title}\marg{title}}
  The \meta{short title} is used in headlines and footlines. Inside
...
\begin{command}{\subtitle\oarg{short subtitle}\marg{subtitle}}
  The \meta{short subtitle} is not used by default, but is available
...
\begin{command}{\part\sarg{mode specification}\oarg{short part name}\marg{part name}}
  ...
  |\partpage| command is used. The \meta{short part name} is not shown
