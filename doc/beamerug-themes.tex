...
\begin{themeexample}[\oarg{options}]{boxes}
...
The following \meta{options} may be given:
  \begin{itemize}
  \item \declare{|headheight=|\meta{dimension}}
  \item \declare{|footheight=|\meta{dimension}}
  \end{itemize}
\end{themeexample}
...
\begin{themeexample}[\oarg{options}]{Boadilla}
  ...
  \item \declare{|shadow|}\opt{|=|\meta{\underline{true} or false}} controls shadows around blocks.
  \end{itemize}
...
\begin{themeexample}[\oarg{options}]{Madrid}
  Like the |Boadilla| theme, except that stronger colors are used and that the itemize icons are not modified. The following \meta{options} may be given:
    \begin{itemize}
    \item \declare{|secheader|} causes a headline to be inserted showing the current section and subsection. By default, this headline is not shown.
    \item \declare{|shadow|}\opt{|=|\meta{\underline{true} or false}} controls shadows around blocks.
    \end{itemize}
...
\begin{themeexample}[\oarg{option}]{AnnArbor}
  Like |Boadilla|, but using the colors of the University of Michigan. The following \meta{option} may be given:
  \begin{itemize}
  \item \declare{|shadow|}\opt{|=|\meta{\underline{true} or false}} controls shadows around blocks.
  \end{itemize}
...
\begin{themeexample}[\oarg{option}]{CambridgeUS}
  Like |Boadilla|, but using the colors of MIT. The following \meta{option} may be given:
  \begin{itemize}
  \item \declare{|shadow|}\opt{|=|\meta{\underline{true} or false}} controls shadows around blocks.
  \end{itemize}
...
\begin{themeexample}[\oarg{option}]{EastLansing}
  Like |Boadilla|, but using the colors of Michigan State University. The following \meta{option} may be given:
  \begin{itemize}
  \item \declare{|shadow|}\opt{|=|\meta{\underline{true} or false}} controls shadows around blocks.
  \end{itemize}
...
\begin{themeexample}[\oarg{options}]{Rochester}
  A dominant theme without any navigational elements. It can be made less dominant by using a different color theme. The following \meta{options} may be given:
  \begin{itemize}
    \item \declare{|height=|\meta{dimension}} sets the height of the frame title bar.
    \item \declare{|width=|\meta{dimension}} sets the width of the sidebar. By default the width is 0 and the sidebar invisible.
...
\begin{themeexample}[\oarg{option}]{Antibes}
  A dominant theme with a tree-like navigation at the top. The rectangular elements mirror the rectangular navigation at the top. The theme can be made less dominant by using a different color theme. The following \meta{option} may be given:
  \begin{itemize}
  \item \declare{|hooks|}\opt{|=|\meta{\underline{true} or false}} causes little ``hooks'' to be drawn in front of the section and subsection entries.
  \end{itemize}

  Antibes is a town in the south of France. It hosted \textsc{stacs} 2002.
\end{themeexample}

\begin{themeexample}[\oarg{option}]{JuanLesPins}
  A variation on the |Antibes| theme that has a much ``smoother'' appearance. It can be made less dominant by choosing a different color theme. The following \meta{option} may be given:
  \begin{itemize}
  \item \declare{|shadow|}\opt{|=|\meta{\underline{true} or false}} controls shadows around blocks.
  \end{itemize}
...
\begin{themeexample}[\oarg{option}]{Montpellier}
  A sober theme giving basic navigational hints. The headline can be made more dominant by using a different color theme. The following \meta{option} may be given:
  \begin{itemize}
  \item \declare{|hooks|}\opt{|=|\meta{\underline{true} or false}} causes little ``hooks'' to be drawn in front of the section and subsection entries.
  \end{itemize}
...
\end{verbatim}
  ...
  This theme is useful for long talks like lectures that require a table of contents to be visible all the time. The following \meta{options} may be given:
  \begin{itemize}
  \item \declare{|hideallsubsections|} causes only sections to be shown in the sidebar. This is useful, if you need to save space.
  \item \declare{|hideothersubsections|} causes only the subsections of the current section to be shown. This is useful, if you need to save space.
  \item \declare{|left|} puts the sidebar on the left (default).
...
\begin{themeexample}[\oarg{options}]{PaloAlto}
  A variation on the |Berkeley| theme with less dominance of rectangular areas. The following \meta{options} may be given:
  \begin{itemize}
  \item \declare{|hideallsubsections|} causes only sections to be shown in the sidebar. This is useful, if you need to save space.
  \item \declare{|hideothersubsections|} causes only the subsections of the current section to be shown. This is useful, if you need to save space.
  \item \declare{|left|} puts the sidebar on the left (default).
...
\begin{themeexample}[\oarg{options}]{Goettingen}
  A relatively sober theme useful for a longer talk that demands a sidebar with a full table of contents. The following \meta{options} may be given:
  \begin{itemize}
  \item \declare{|hideallsubsections|} causes only sections to be shown in the sidebar. This is useful, if you need to save space.
  \item \declare{|hideothersubsections|} causes only the subsections of the current section to be shown. This is useful, if you need to save space.
  \item \declare{|left|} puts the sidebar on the left (default).
...
\begin{themeexample}[\oarg{options}]{Marburg}
  A very dominant variation of the |Goettingen| theme. The following \meta{options} may be given:
  \begin{itemize}
  \item \declare{|hideallsubsections|} causes only sections to be shown in the sidebar. This is useful, if you need to save space.
  \item \declare{|hideothersubsections|} causes only the subsections of the current section to be shown. This is useful, if you need to save space.
  \item \declare{|left|} puts the sidebar on the left (default).
...
\begin{themeexample}[\oarg{options}]{Hannover}
  In this theme, the sidebar on the left is balanced by right-flushed frame titles. The following \meta{options} may be given:
  \begin{itemize}
  \item \declare{|hideallsubsections|} causes only sections to be shown in the sidebar. This is useful, if you need to save space.
  \item \declare{|hideothersubsections|} causes only the subsections of the current section to be shown. This is useful, if you need to save space.
  \item \declare{|left|} puts the sidebar on the left (default).
...
\begin{themeexample}[\oarg{options}]{Berlin}
  ...
  \item \declare{|subsection|}\opt{|=|\meta{\underline{true} or false}} shows or surpresses line showing the subsection in the headline.
  \item \declare{|footline=|\meta{...}} allows choosing different footlines. See the |miniframes| outer theme for available footlines.
  \end{itemize}
...
\begin{themeexample}[\oarg{options}]{Ilmenau}
  A variation on the |Berlin| theme. The following \meta{options} may be given:
  \begin{itemize}
  \item \declare{|compress|} causes the mini frames in the headline to use only a single line. This is useful for saving space.
  \item \declare{|subsection|}\opt{|=|\meta{\underline{true} or false}} shows or surpresses line showing the subsection in the headline.
  \item \declare{|footline=|\meta{...}} allows choosing different footlines. See the |miniframes| outer theme for available footlines.
...
\begin{themeexample}[\oarg{options}]{Dresden}
  A variation on the |Berlin| theme with a strong separation into navigational stuff at the top/bottom and a sober main text. The following \meta{options} may be given:
  \begin{itemize}
  \item \declare{|compress|} causes the mini frames in the headline to use only a single line. This is useful for saving space.
  \item \declare{|subsection|}\opt{|=|\meta{\underline{true} or false}} shows or surpresses line showing the subsection in the headline.
  \item \declare{|footline=|\meta{...}} allows choosing different footlines. See the |miniframes| outer theme for available footlines.
...
\begin{themeexample}[\oarg{options}]{Darmstadt}
  A theme with a strong separation into a navigational upper part and an informational main part. By using a different color theme, this separation can be lessened. The following \meta{options} may be given:
  \begin{itemize}
  \item \declare{|subsection|}\opt{|=|\meta{\underline{true} or false}} shows or surpresses line showing the subsection in the headline.
  \item \declare{|shadow|}\opt{|=|\meta{\underline{true} or false}} controls shadows around blocks.
  \end{itemize}
...
\begin{themeexample}[\oarg{options}]{Frankfurt}
  A variation on the |Darmstadt| theme that is slightly less cluttered by leaving out the subsection information. The following \meta{options} may be given:
  \begin{itemize}
  \item \declare{|subsection|}\opt{|=|\meta{\underline{true} or false}} shows or surpresses line showing the subsection in the headline.
  \item \declare{|shadow|}\opt{|=|\meta{\underline{true} or false}} controls shadows around blocks.
  \end{itemize}
...
\begin{themeexample}[\oarg{options}]{Singapore}
  A not-too-sober theme with navigation that does not dominate. The following \meta{options} may be given:
  \begin{itemize}
  \item \declare{|compress|} causes the mini frames in the headline to use only a single line. This is useful for saving space.
  \item \declare{|subsection|}\opt{|=|\meta{\underline{true} or false}} shows or surpresses line showing the subsection in the headline.
  \item \declare{|footline=|\meta{...}} allows choosing different footlines. See the |miniframes| outer theme for available footlines.
...
\begin{themeexample}[\oarg{options}]{Szeged}
  A sober theme with a strong dominance of horizontal lines. The following \meta{options} may be given:
  \begin{itemize}
  \item \declare{|compress|} causes the mini frames in the headline to use only a single line. This is useful for saving space.
  \item \declare{|subsection|}\opt{|=|\meta{\underline{true} or false}} shows or surpresses line showing the subsection in the headline.
  \item \declare{|footline=|\meta{...}} allows choosing different footlines. See the |miniframes| outer theme for available footlines.
...
\begin{themeexample}[\oarg{option}]{Warsaw}
  A dominant variation of the |Copenhagen| theme. The following \meta{option} may be given:
  \begin{itemize}
  \item \declare{|shadow|}\opt{|=|\meta{\underline{true} or false}} controls shadows around blocks.
  \end{itemize}
