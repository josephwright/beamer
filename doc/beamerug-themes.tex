...
\begin{themeexample}[\oarg{options}]{Boadilla}
  A theme giving much information on little space.
...
\begin{themeexample}{Luebeck}
  ...
  Lübeck is a town in nothern Germany. It hosted the 41st Theorietag.
\end{themeexample}

\begin{themeexample}{Malmoe}
  A more sober variation of the |Copenhagen| theme.

  Malmö is a town in southern Sweden. It hosted \textsc{fct} 2001.
\end{themeexample}
