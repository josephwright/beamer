...
\begin{fontthemeexample}[\oarg{options}]{italics}
  ...
  makes text bold, |italics| makes sets it italics \emph{and in a
    serif font}. The same \meta{options} as for the |bold| theme are
  supported. See Section~\ref{section-italics} for the pros and cons
  of using italics.  
\end{fontthemeexample}

\begin{fontthemeexample}[\oarg{options}]{smallcaps}
  ...
  only this time text is set using small caps \emph{and a serif
    font}. The same \meta{options} as for the |bold| theme are
