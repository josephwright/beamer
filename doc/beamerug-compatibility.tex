...
\begin{package}{{musixtex}}
  When using  MusiX\TeX\ to typeset  musical scores, you should  use the
  |musixtex| class option. When using this option, your document must be
  compiled with |pdfelatex| or |elatex| instead of |pdflatex| or
  |latex|.  
  ...
  \articlenote
  Add the option |musixtex| when loading |beamerarticle|.
\end{package}
