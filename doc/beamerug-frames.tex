...
% Copyright 2021-2026 by Joseph Wright, samcarter
%
...
\begin{tikzpicture}[z={(0.97,0)},x={(.55,.4)},scale=0.88]
...
\path (#2) [draw,<-,thick] -- (#2 |- 0,-\bepgh-#1,0) node[below,align=center,font=\footnotesize] {#3};
\stepcounter{zlayer}}
\newcounter{zlayer}
\setcounter{zlayer}{0}
...
% background hook
\draw[gray,dashed] (0,0,\zlayer) -- ++(\bepgw,0,0) -- ++(0,-\bepgh,0) -- ++(-\bepgw,0,0) -- cycle;
\component[3]{1,-\bepgh,\zlayer}{\makebox[0pt][c]{shipout/background}\\ \makebox[0pt][c]{\LaTeX\ hook}}
...
% foreground hook
\draw[gray,dashed] (0,0,\zlayer) -- ++(\bepgw,0,0) -- ++(0,-\bepgh,0) -- ++(-\bepgw,0,0) -- cycle;
\component[3]{1,-\bepgh,\zlayer}{shipout/foreground\\ \LaTeX\ hook}
...
\end{verbatim}
    ...
    Inserts the current subsubsection into a template.
