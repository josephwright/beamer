...
\centerline{\begin{tikzpicture}[z={(0.97,0)},x={(.55,.4)}]
...
\foreach \z in {0,12} {
  \draw[gray,dashed] (0,-\bepgh,\z) -- (\bepgw,-\bepgh,\z) -- (\bepgw,0,\z);
}


% background hook
\path (1,-\bepgh,\zlayer) [draw,<-,thick] -- (1,-\bepgh,\zlayer |- 0,-\bepgh-3,0) node[below,text width=3cm,align=center] (shipout/background LaTeX hook) {shipout/background \LaTeX\ hook};
\stepcounter{zlayer}
...
% foreground hook
\path (1,-\bepgh,\zlayer) [draw,<-,thick] -- (1,-\bepgh,\zlayer |- 0,-\bepgh-3,0) node[below,text width=3cm,align=center] (shipout/foreground LaTeX hook) {shipout/foreground \LaTeX\ hook};
\stepcounter{zlayer}

\addtocounter{zlayer}{-2}

\foreach \z in {1,...,\zlayer} {
  \draw[gray,ultra thick] (0,-\bepgh,\z) -- (0,0,\z) -- (\bepgw,0,\z);
}
\foreach \z in {0,12} {
  \draw[gray,dashed] (0,-\bepgh,\z) -- (0,0,\z) -- (\bepgw,0,\z);
}
