...
Most linux distributions provided pre-packaged bundles of \TeX{} Live. It is probably easiest to install a full (or at least recommended) scheme of \TeX{} Live, but if you only want to install \beamer:

\begin{itemize}
\item
  Ubuntu/Debian: |apt install latex-beamer|
\item 
