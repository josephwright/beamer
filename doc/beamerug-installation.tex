...
Normal |latex| and |dvips| should work with any version. Concerning
|pdflatex| and |lyx|, which are optional, I use:
\begin{itemize}
\item
  |lyx| version 1.3.3,
\item
  |pdflatex| version 3.14159-14h (Web2C 7.3.3.1). I know
  that there is trouble with some older versions, in particular
  version 3.14159-13d does not seem to work. Try updating to a newer
  version or, even better, find whatever is causing the problem and
  send me a fix.
\end{itemize}
