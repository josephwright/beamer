...
\Parameters{
\item A comma-separated rgb triple specifying the color at the bottom
  of the side bar.
\item A comma-separated rgb triple specifying the color at the top
  of the side bar.
  }
\Description{
...
\Example
\begin{verbatim}
\useleftsidebarverticalshadingtemplate{1,1,1}{1,0,0} % white to red
\end{verbatim}


\Command{useleftsidebarhorizontalshadingtemplate}
\Parameters{
\item A comma-separated rgb triple specifying the color at the left
  end of of the side bar.
\item A comma-separated rgb triple specifying the color at the right
  end of the side bar.
  }
\Description{
...
\Example
\begin{verbatim}
\useleftsidebarhorizontalshadingtemplate{1,1,1}{1,0,0} % white to red
\end{verbatim}
