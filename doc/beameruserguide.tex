...
Inside the appendix, you should not use the |\section| command,
but you can use the |\subsection| command to structure the
appendix. Use the |\tableofcontents| command to insert a table of
contents of the appendix into the current frame.

\begin{command}{\appendix}
  Starts the appendix. All frames and all |\subsection| commands
